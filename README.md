# hockey_preds_dashboard

Dashboard for hockey predictions scores

Built with ❤️ by [g1t-john](https://github.com/g1t-john)
...
git clone git@github.com:g1t-john/hockey_preds_dashboard.git

# Go to correct directory
cd hockey_preds_dashboard
